...
- [Amazon's Amplify UI](https://ui.docs.amplify.aws/) uses XState for its Authenticator component ([see here](https://github.com/aws-amplify/amplify-ui/blob/main/packages/ui/src/machines/authenticator/index.ts))
